...
func TestReviewerIntegration(t *testing.T) {
	...
	resp, err := r.Review(ctx, reviewer.ReviewRequest{
		Prompt: "Return one JSON object matching the supplied schema. Use verdict ready_to_build, summary integration smoke, and empty concerns, questions, and proposed_diffs arrays.",
